...
import { renderDashboard, renderFeedAndHistory, analyzeMyWorks, generateSummary, fetchMpStats, syncMpOfficial, openMpWhitelistModal, startMpWhitelistJob, setActionStatus } from './pages/dashboard.js';
...
import { renderSettings, openEnvModal, openRedfoxApply, saveEnvConfig, restartService, loadQuota, renderNotificationSettings, notificationInput, saveNotificationSettings, testNotification, cronCostMeta, renderCronList, toggleCron, runCronNow, openCronModal, submitCron, deleteCron, renderInspirationConfigs, openInspirationConfigDetail, openInspirationConfigModal, parseTermInput, submitInspirationConfig, deleteInspirationConfigUi, runInspirationConfig, toggleInspirationConfig, openXhsMcpConfig, saveXhsMcpConfig, xhsMcpHealth, xhsMcpLoginQr, xhsMcpResetLogin, installXhsMcpCli, copyText, openWersssConfig, saveWersssConfig, forceWersssQr, closeWersssQrModal, refreshWersssQr } from './pages/settings.js';
...
import { renderSkills, filterSkills, openSkillDetail, openAgentWithSkill, checkSkillUpdates, updateCommunitySkillsUi, renderAgent, loadAgentThreads, saveAgentThreads, startNewAgentThread, switchAgentThread, clearCurrentAgentThread, deleteAgentThread, copySessionId, toggleResumeMode, renderAgentThreads, onAgentProviderChange, formatTime, copyAgentMessage, deleteAgentMessage, regenerateAgentMessage, toggleStreamingIndicator, handleAgentInputKeydown, renderAgentMessages, showSkillCommands, insertSkillCommand, sendAgentMessage, loadSkills, clearSkillCache, bindSkillToSource, reclassifySkills, bindSkillTabs, newCustomSkill, editCustomSkill, deleteCustomSkill, saveCustomSkill, refreshCustomSkills, renderCustomSkills, loadHubSkills, searchHubSkills, installHubSkill, uninstallHubSkill, renderSkillTemplates, generateFromTemplate } from './pages/agent.js';
...
registerAction('analyzeMyWorks', (el, d) => analyzeMyWorks(el, d));
registerAction('fetchMpStats', (el) => fetchMpStats(el));
registerAction('syncMpOfficial', (el, d) => syncMpOfficial(el, d));
registerAction('openMpWhitelistModal', (_, d) => openMpWhitelistModal(d.ip || ''));
registerAction('startMpWhitelistJob', (el, d) => startMpWhitelistJob(el, d));
registerAction('generateSummary', (el) => generateSummary(el));
registerAction('setActionStatus', (el, d) => setActionStatus(el, d));
...
registerAction('newCustomSkill', () => newCustomSkill());
registerAction('editCustomSkill', (el, d) => editCustomSkill(el, d));
registerAction('deleteCustomSkill', (el, d) => deleteCustomSkill(el, d));
registerAction('saveCustomSkill', (el, d) => saveCustomSkill(el, d));
registerAction('refreshCustomSkills', () => refreshCustomSkills());
registerAction('loadHubSkills', () => loadHubSkills());
registerAction('searchHubSkills', () => searchHubSkills());
registerAction('installHubSkill', (el, d) => installHubSkill(el, d));
registerAction('uninstallHubSkill', (el, d) => uninstallHubSkill(el, d));
registerAction('generateFromTemplate', (el, d) => generateFromTemplate(el, d));
...
registerAction('copySessionId', (_, d) => copySessionId(d.id));
registerAction('toggleResumeMode', (_, d) => toggleResumeMode(d.id));
...
registerAction('openXhsMcpConfig', () => openXhsMcpConfig());
registerAction('saveXhsMcpConfig', () => saveXhsMcpConfig());
registerAction('xhsMcpHealth', () => xhsMcpHealth());
registerAction('xhsMcpLoginQr', () => xhsMcpLoginQr());
registerAction('xhsMcpResetLogin', () => xhsMcpResetLogin());
registerAction('installXhsMcpCli', () => installXhsMcpCli());
registerAction('copyText', (el, d) => copyText(el, d));
